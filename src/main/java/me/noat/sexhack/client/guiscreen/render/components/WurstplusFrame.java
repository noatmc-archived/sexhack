...
public class WurstplusFrame {
	...
	public void render(int mx, int my) {
		...
		int nc_r = SexHack.click_gui.theme_frame_name_r;
		int nc_g = SexHack.click_gui.theme_frame_name_g;
		int nc_b = SexHack.click_gui.theme_frame_name_b;
		int nc_a = SexHack.click_gui.theme_frame_name_a;

		int bg_r = SexHack.click_gui.theme_frame_background_r;
		int bg_g = SexHack.click_gui.theme_frame_background_g;
		int bg_b = SexHack.click_gui.theme_frame_background_b;
		int bg_a = SexHack.click_gui.theme_frame_background_a;

		int bd_r = SexHack.click_gui.theme_frame_border_r;
		int bd_g = SexHack.click_gui.theme_frame_border_g;
		int bd_b = SexHack.click_gui.theme_frame_border_b;
		int bd_a = border_a;
