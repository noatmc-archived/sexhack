...
public
class WurstplusPinnable {
    public final Minecraft mc = Minecraft.getMinecraft();
    public final WurstplusDraw font;
    ...
    public
    WurstplusPinnable(String title, String tag, float font_, int x, int y) {
        this.title = title;
        this.tag = tag;
    ...
    protected
    void createLineWithShadow(String string, int pos_x, int pos_y, Color color) {
        Minecraft.getMinecraft().fontRenderer.drawStringWithShadow(string, this.x + pos_x, this.y + pos_y, color.hashCode());
    }

    protected
    void createLine(String string, int pos_x, int pos_y, int color) {
