...
public
class WurstplusTextureHelper {

    final static Minecraft mc = Minecraft.getMinecraft();

    public static
    void drawTexture(final ResourceLocation resourceLocation, final float x, final float y, final float width, final float height) {
        GL11.glPushMatrix();
    ...
    public static
    void bindTexture(final ResourceLocation resourceLocation) {
        try {
