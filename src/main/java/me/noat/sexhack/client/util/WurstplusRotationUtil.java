...
class WurstplusRotationUtil {
    ...
    public
    void setPlayerYaw(final float yaw) {
        mc.player.rotationYaw = yaw;
        mc.player.rotationYawHead = yaw;
    }

    public
    void lookAtPos(final BlockPos pos) {
    ...
    public
    void lookAtVec3d(final Vec3d vec3d) {
    ...
    public
    void lookAtVec3d(final double x, final double y, final double z) {
        final Vec3d vec3d = new Vec3d(x, y, z);
        this.lookAtVec3d(vec3d);
    }

    public
    void lookAtEntity(final Entity entity) {
    ...
    public
    void setPlayerPitch(final float pitch) {
        mc.player.rotationPitch = pitch;
    }
    ...
    public
    String getDirection4D(final boolean northRed) {
